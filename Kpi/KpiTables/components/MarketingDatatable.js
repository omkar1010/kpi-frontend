...
// const MarketingDatatable = () => {
//   return (
//     <div>MarketingDatatable</div>
//   )
// }

// export default MarketingDatatable
...
const MarketingDatatable = ({ category, subcategory }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`http://localhost:8080/api/getMarketing/${category}`);
